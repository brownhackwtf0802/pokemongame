...
const u16 gTrainerPalette_Ghost[] = INCBIN_U16("graphics/trainers/front_pics/ghost.gbapal");

const u32 gTrainerFrontPic_Soap[] = INCBIN_U32("graphics/trainers/front_pics/soap.4bpp.smol");
const u16 gTrainerPalette_Soap[] = INCBIN_U16("graphics/trainers/front_pics/soap.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_GHOST, gTrainerFrontPic_Ghost, gTrainerPalette_Ghost),
    TRAINER_SPRITE(TRAINER_PIC_SOAP, gTrainerFrontPic_Soap, gTrainerPalette_Soap),
};
